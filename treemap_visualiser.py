...
def run_treemap_papers() -> None:
    ...
    """
    paper_tree = PaperTree('CS1', [], by_year=False, all_papers=True)
...
if __name__ == '__main__':
    ...
    # run_treemap_file_system('/Users/leilasalem/Downloads/csc148/assignments/a2/example-directory')
    #run_treemap_file_system('/Users/leilasalem/Desktop/papertree/example-directory')
